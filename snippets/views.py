...
################################################################################################################
# 4. Authentication and Permissions (Add User part)
################################################################################################################
# move to up
# from django.contrib.auth.models import User
# from snippets.models import Snippet
...
################################################################################################################
#--------------------------------------------------------------------------------------------------------------#
# Using Generic Class-based Views (Very Simple)
#--------------------------------------------------------------------------------------------------------------#
# move to up
# from snippets.models import Snippet
...
# ################################################################################################################
# 2. Response / Request / Api views / Suffixes URL
# ################################################################################################################
# from rest_framework import status
# from rest_framework.decorators import api_view
# from rest_framework.response import Response
...
# @api_view(['GET','POST'])
# # @csrf_exempt
# def snippet_list(request, format=None): # format 은 suffix URL 처리를 위해 추가됨.
#     if request.method == "GET":
#         snippets = Snippet.objects.all()
#         serializer = SnippetSerializer(snippets, many=True)
#         return Response(serializer.data) # Response를 따로 명시할 필요 없음.
#         # return JsonResponse(serializer.data, safe=False)
#
#     elif request.method == "POST":
#         serializer = SnippetSerializer(data=request.data) # request 도 유연하게 처리됨.
...
#             return Response(serializer.data, status=status.HTTP_201_CREATED)
#         return Response(serializer.errors, status=status.HTTP_400_BAD_REQUEST)
#         #     return JsonResponse(serializer.data, status=201) # status 도 보기 명확하게 처리 가능.
